...
public class DonationListView {
	...
	private List<DonationListDTO> messageList; // 방명록 List
	...
	public DonationListView(int messageTotalCount, int currentPageNumber, List<DonationListDTO> messageList,
	...
	public List<DonationListDTO> getMessageList() {
		return messageList;
	}

	public void setMessageList(List<DonationListDTO> messageList) {
		this.messageList = messageList;
	}
