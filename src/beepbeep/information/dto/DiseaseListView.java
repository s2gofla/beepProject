...
public class DiseaseListView {
	...
	private List<DiseaseListDTO> List;
	...
	public DiseaseListView(int totalCount, int currentPageNumber, java.util.List<DiseaseListDTO> list, int countPerPage,
	...
	public List<DiseaseListDTO> getList() {
		return List;
	}
	public void setList(List<DiseaseListDTO> list) {
		List = list;
	}
