	...
	<div align="center">
		...
		<div class="contentBody">
			...
			<div class="writehashtag">
				<textarea placeholder="#태그를 입력해주세요. ex) #치과 #충치 "></textarea>
			</div>

			<div class="btns">
				<input type="submit" value="작성 완료">
				<input type="reset" value="다시 작성" onclick="location.href='diseasewrite.jsp'">
				<input type="button" value="목록" onclick="location.href='diseaselist.jsp'">
			</div>
		</div>
		<!-- contentBody -->
		<!-- 
