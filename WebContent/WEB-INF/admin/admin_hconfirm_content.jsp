	...
	<div class="layout-main">
		...
		<div class="layout-right-block">
			...
			<div class="contentmem">
				...
				<h1>병원리뷰</h1>
				<div class="mem">
					<img src="../beep_images/community-images/girl.svg" alt="" />${hconfirmViewData.id }

				</div>
				<span>${hconfirmViewData.dates } </span> <br />
				<hr />
				<br />
				<!-- 내용 -->
				<div class="contentcon">
					<div>${hconfirmViewData.contents}</div>
			...
			<%-- 	<c:if test="${authUser.mgrade_code eq 9 }"></c:if> --%>
				<div class="conunder">     
					<a href="/beepPro/admin/admin_Hconfirm.do?seq=${seq }"><button>승인</button></a>
					<a href="/beepPro/admin/admin_Hconfirm_Delete.do?seq=${seq }"><button>삭제</button></a>
				</div>
