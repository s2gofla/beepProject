	...
	<div class="layout-main">
		...
		<div class="layout-right-block">
			...
			<div class="contentmem">
				...
				<h1>${reportViewData.report_name }</h1>
				<div class="mem">
					<img src="../beep_images/community-images/girl.svg" alt="" />${reportViewData.id }

				</div>
				<span>${reportViewData.dates } </span> <br />
				<hr />
				<br />
				<!-- 내용 -->
				<div class="contentcon">
					<div>${reportViewData.contents}</div>
