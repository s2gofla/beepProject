 ...
 <!-- The Modal -->
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
                <p style="text-align: center;"><span style="font-size: 14pt;"><b><span style="font-size: 24pt;">승인</span></b></span></p>
                <p style="text-align: center; line-height: 1.5;"><br />승인하시겠습니까?</p>
                <p><br /></p>
