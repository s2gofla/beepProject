...
<!--*******  경로맞춰서 css style 부여 -->
<link rel="stylesheet" href="hrevWrite-style.css?var=157262"
...
<body>
	...
	<form action="../review/hreview_write.do" method="post" enctype="multipart/form-data">
		...
		<div class="review-body a1">
			...
			<div class="review-contentbox p1 mt1 col justify">
				...
				<div class="row">
					<div class="row col mb5 justify price odd">
						<div>치료항목</div>
						<div>치료항목</div>
						<div>치료항목</div>
					</div>
			...
			<div class="review-contentbox p1 col mt1 justify">
				...
				<div class="row mb5 justify">
					<div class="row justify col a1 filebtn">
						<label for="ex_file" class="review-button a1 justify">영수증
							첨부하기</label> <input type="file" id="ex_file" name="rfile" />
