...
<link rel="stylesheet" href="m10_withdrawal.css?var=13402" type="text/css" charset="UTF-8" />
<link
					...
					<div class="m_GPC_borderMid">
						...
						<div class="m_GPC_content">
							...
							<div class="m_GPC_bottom">
								<button class="m_GPC_button1" onclick="location.href='../main/main.jsp'">확인</button>
							</div>	<!-- m_GPC_bottom -->
