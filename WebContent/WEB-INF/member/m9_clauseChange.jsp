...
<link rel="stylesheet" href="m9_clauseChange.css?var=1340277" type="text/css" charset="UTF-8" />
<link
...
<body>
<form action="changeClause.do" method="post">
				...
				<div class="m_clause_clauseTotal">
					...
					<div class="m_clause_checkTotal">
						<div class="m_clause_check">
							<p id="m_clause_C">동의</p>
							<input type="checkbox" name="m_clause_TC1" class="m_clause_TC" title="위치기반동의" value="1" onclick="check_action(this,'group1');">
							<ins></ins>
						</div>
						<div class="m_clause_check">
							<p id="m_clause_C">미동의</p>
							<input type="checkbox" name="m_clause_TC1" class="m_clause_TC" title="위치기반미동의" value="2" onclick="check_action(this,'group1');">
							<ins></ins>
						</div>
					...
					<div class="m_clause_checkTotal">
						<div class="m_clause_check">
							...
							<input type="checkbox" name="m_clause_TC2" class="m_clause_TC" title="이용약관" value="1" onclick="check_action(this,'group2');">
							<ins></ins>
						</div>
						
						<div class="m_clause_check">
							<p id="m_clause_C">Email 수신동의</p>
							<input type="checkbox" name="m_clause_TC2" class="m_clause_TC" title="이용약관"  value="2" onclick="check_action(this,'group2');">
							<ins></ins>
						</div>
						
						<div class="m_clause_check">
							<p id="m_clause_C">미동의</p>
							<input type="checkbox" name="m_clause_TC2" class="m_clause_TC" title="미동의"  value="3" onclick="check_action(this,'group2');">
							<ins></ins>
						</div>
