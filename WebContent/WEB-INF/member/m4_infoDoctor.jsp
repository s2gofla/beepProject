			...
			<div class="m_infoD_main">
				...
				<div class="m_infoD_totalTop">
					<div class="m_infoD_top1">
						<h1 class="m_infoD_top1_text">회원가입</h1>
					</div>
					<!--m_infoD_top1  -->

					<div class="m_infoD_top2">
						<!-- 순서도 숫자  시작-->

						<!-- 1 -->
						<div class="m_infoD_numSub">
							<div class="m_infoD_top2_numCircle">
								<p id=m_infoD_num>1</p>
							</div>
							<div class="m_infoD_numBottonText">약관동의</div>
						</div>
						<!--m_infoD_numSub  -->
						...
						<div class="m_infoD_numSub">
							<div class="m_infoD_top2_numCircle">
								<p id=m_infoD_num>2</p>
							</div>
							<div class="m_infoD_numBottonText">본인인증</div>
						</div>
						<!--m_infoD_numSub"  -->
						...
						<!-- 3 -->
						<div class="m_infoD_numSub">
							<div class="m_infoD_top2_numCircle3">
								<p id=m_infoD_num>3</p>
							</div>
							<div class="m_infoD_numBottonText">[ 정보입력 ]</div>
						</div>
						<!--m_infoD_numSub"  -->
						...
						<div class="m_infoD_numSub">
							<div class="m_infoD_top2_numCircle">
								<p id=m_infoD_num>4</p>
							</div>
							<div class="m_infoD_numBottonText">가입완료</div>
				...
				<div class="m_infoD_nextButton">
					<button id="m_infoD_button" onclick="location.href = '../member/m5_joinFinish.jsp' ">다음</button>
				</div>
