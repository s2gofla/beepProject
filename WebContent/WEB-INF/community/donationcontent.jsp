...
<body>
	...
	<div class="layout-main">
			...
			<ul>
				...
				<ul class="community">
					...
					<c:forEach items="${categoryList}" var="list">
						<li><a href="/beepPro/community/disease_list.do?m_sub_seq=${dto.m_sub_seq }">&gt; ${ list.m_sub_name }</a></li>
					</c:forEach>
					</ul>
					<hr />
		...
		<div class="layout-right-block">
			...
			<div class="contentmem">
				...
				<input type="button" value="목록" onclick="location.href='/beepPro/community/donation_list.do?page=${param.page}&searchCondition=${param.searchCondition}&searchWord=${param.searchWord}'"  />
				<input type="button" value="수정" onclick="location.href='/beepPro/community/donation_update.do?d_seq=${dto.d_seq}'" />
				<input type="button" value="삭제" onclick="location.href='/beepPro/community/donation_delete.do?d_seq=${dto.d_seq}'"/>
				<hr />
				<br />
				<!-- 내용 -->
         ...
         <form action="/beepPro/manager/reportPosts.do" onsubmit="return checkReport();">
            ...
            <input type="hidden" name="board_seq" value="${dto.d_seq }" />
            <input type="hidden" name="all_board_seq" value="4" />
            ...
            <input type="submit" value="보내기"  class="submit report_submit" />
				...
				<!-- 댓글달기 -->
				<br />
				<form action="/beepPro/community/donation_comwrite.ajax" method="post" id="comment_form" class="donation_comment">
				<div class="contentcommentw">
				<input type="hidden" value="${dto.d_seq }" name="d_seq" />
				...
				<br />
				<div id="donation_combox${comdto.seq}">
			...
			<!-- 한 개의 댓글 -->
			    ...
			    <!-- 대댓글 쓰기 -->
				<form action="/beepPro/community/donation_ccomwrite.ajax" method="post" id="ccomment_form${comdto.seq}" class="donation_ccomment">
				...
				<div class="commentbox" id="ccomentbox${ccomdto.doreply_seq}">
				<br />
				...
				<input type="button" value="삭제" onclick="ccommentDelete(this)" id="ccomdelete${ccomdto.doreply_seq}"/>
				</c:if>
	...
	<script src = "/beepPro/community/community-style/docomment.js?var=322">
	</script>
	...
	function submitcoco(submit){
	      ...
	      if(id==null || id==""){
	        ...
	        $.each(data, function(index, item) {
				html += "<div class='commentbox' id='ccomentbox"+item.doreply_seq+"'>";
				html += "<br />";
				...
				html += "<input type='button' value='삭제' onclick='ccommentDelete(this)' id='ccomdelete"+item.doreply_seq+"' />";
				html += "</c:if>";
	               ...
	               if(authid==null||authid==""){
	                  alert("로그인 후 이용 가능합니다.");
	            		...
	            		if(toggle=="e"){
	            			...
	            			likeAjaxConn('/beepPro/community/donation_likebtn.ajax?like=y&seq='+seq);
	            		}else if(toggle="d"){
	            			$('#'+id).attr("src","../beep_images/community-images/whitelike.svg");
	            			likeAjaxConn('/beepPro/community/donation_likebtn.ajax?like=n&seq='+seq);
	            		}
	               }
	            }
