...
<body>
	...
	<div align="center">
		<p class="write">
			<img src="../beep_images/community-images/boardpencil.svg" alt="" />자유게시판 수정하기
		</p>
		<form method="post">
		<div class="contentBody">
			...
			<div class="writehashtag">
				<textarea placeholder="#태그를 입력해주세요." name="hashtag" >${dto.hashtag}</textarea>
			</div>

			<div class="btns">
				<input type="submit" value="작성 완료">
				<input type="reset" value="다시 작성" onclick="location.href='/beepPro/community/free_update.do'">
				<input type="button" value="목록" onclick="location.href='/beepPro/community/free_list.do'">
			</div>
		</div>
		</form>
		<!-- contentBody -->
