...
<body>
	...
	<div align="center">
		<p class="write">
			<img src="../beep_images/community-images/boardpencil.svg" alt="" />자유게시판 글쓰기
		</p>
		<form method="post">
		<div class="contentBody">
			<div class="wrtieTitle">
				<input type="text" placeholder="제목을 입력해주세요." name="writetitle" /> <!-- maintitle -->
			</div>
			...
			<div class="btns">
				...
				<input type="reset" value="다시 작성" onclick="location.href='/beepPro/community/free_write.do'">  
