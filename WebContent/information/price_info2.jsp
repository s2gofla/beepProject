...
<div id="container">	
	<div id="content">
		<div class="section_wrap ">
			<div id="wrap">
				<a href="#inf_modal" data-toggle="modal" data-params='1' class="flatbtn modaltrigger" id="modaltrigger">
					<h3 class="stress">비뇨기과 검사</h3>
				</a>	
				<a href="#inf_modal" data-toggle="modal" data-params='2' class="flatbtn modaltrigger" id="modaltrigger">
...
$(function(){  
  $('#inf_modal').on('show.bs.modal', function(event){
	  var button = $(event.relatedTarget);
	  var params = button.data('params');
	  $("#inf_modal").modal('show');
	  console.log(params);
  })
});
</script>
